...
import com.tienda.demo.service.DistribuidorServicio;
...
public class DistribuidoresControlador {
    ...
    public ResponseEntity<distribuidores>distribuidorPorCC(@PathVariable Long Nit_Distribuidor){
    ...
    public ResponseEntity<Void> eliminarnitDistribuidor(@PathVariable Long nit_Distribuidor) {
        if (distribuidorServicio.distribuidoresPorCC(nit_Distribuidor) != null) {
