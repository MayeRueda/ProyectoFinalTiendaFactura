...
public class detalles {
    ...
    private Long cod_Identificacion;
    ...
    public detalles(Long cod_Identificacion, int cantidad, int codigodetalle, int precio, int pago, pedidos_productos pedidos_productos) {
    ...
    public Long getCod_Identificacion() {
        return cod_Identificacion;
    }

    public void setCod_Identificacion(Long cod_Identificacion) {
        this.cod_Identificacion = cod_Identificacion;
    }
    ...
    public void setPedidos_productos(pedidos_productos pedidos_productos) {
        this.pedidos_productos = pedidos_productos;
    }
}