...
public class empleados {
    ...
    public empleados(Long cc_Empleado, String nomEmpleado, int salario_Empleado, String horario, String cargo) {
    ...
    public Long getCc_Empleado() {
        return cc_Empleado;
    }

    public void setCc_Empleado(Long cc_Empleado) {
        this.cc_Empleado = cc_Empleado;
    }
