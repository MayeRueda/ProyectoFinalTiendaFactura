...
public interface ProductoCrudRepository extends CrudRepository<productos,Long> {
    ...
    List<productos> BuscarProductoPorcod_Pedido(@Param("cod_Pedido") Long cod_Pedido);
    ...
    void actualizarProductos(@Param("nomProducto") String nomProducto,  @Param("cod_Producto") Long cod_Producto);
