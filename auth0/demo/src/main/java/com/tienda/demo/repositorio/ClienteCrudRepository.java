...
public interface ClienteCrudRepository extends CrudRepository<clientes,Long> {
 ...
 List<detalles> BuscarDetalleEnClientes(@Param("codCompra") Long codCompra);
    ...
    void actualizarClientes(@Param("nomCliente") String nomCliente, @Param("cc_clientes") Long cc_clientes);
